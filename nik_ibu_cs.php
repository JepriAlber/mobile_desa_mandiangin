...
<body onload='search()'>
	...
	<div data-role="content">
		...
		<center><h4>Isi Data Ibu Calon Suami</h4></center>

			<form class="form-horizontal" role="search" method="POST" action="">
			
			<div class="col-md-8 col-xs-12">
        		<input type="number" name="nik" class="form-control" placeholder="NIK Ibu Calon Suami" required>
    	   		<button class="btn btn-default" type="submit" name="submit-search">Cari</button>
    		</div>
			</form>

			<?php
				if (isset($_POST['submit'])&&$_POST['submit']=='ayah_cs') {
					$_SESSION['nik_ayah_cs']=$_POST['nik'];
				}
				...
				{
			?>
				<form class="form-horizontal" role="search" method="POST" action="nik_ayah_ci.php">
					<label>NIK</label>
				...
				<!-- <button class="btn btn-default" type="submit" name="submit" value="ibu_cs">Lanjut</button> -->

				<table width="100%" height="100%">
					<tr>
						<td width="50%"><a href="nik_ayah_cs.php" class="ui-btn ui-icon-back ui-btn-icon-right ui-corner-all ui-shadow">Kembali</a></td>
						<td width="50%"><button type="submit" name="submit" value="ibu_cs" class="ui-btn ui-icon-navigation ui-btn-icon-right ui-corner-all ui-shadow">Lanjut</button></td>
					</tr>
				</table>
				</form>
			<?php
